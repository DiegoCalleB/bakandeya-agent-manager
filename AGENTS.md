...
- [x] `enviador.py` + Gmail OAuth (creación segura de borradores firmados por 'Bakandeya IA Management')
...
- [x] `lib/metricas.py` & `agents/agente_metricas.py` — Módulo de telemetría de booking, YouTube Data API v3 y Dashboard de rendimiento en Telegram
- [x] `lector_bandeja.py` funcionando con análisis JSON estructurado de respuestas, fechas/ofertas en notas y notificaciones Telegram enriquecidas
